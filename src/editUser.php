        ...
        <form class="card-body items-center text-center" action="" method="post">
            ...
            <div class="form-control w-full max-w-xs">
                <label class="label cursor-pointer">
                    ...
                    <input type="radio" id="adminYes" name="permitions" class="radio" value="yes" <?php echo ($result[0]['id_type'] == '1' ? "checked " : ""); echo ($_GET['id'] == $_SESSION['username'] ? "disabled" : "") ?> />
                </label>
                <label class="label cursor-pointer">
                    <span class="label-text">Utilizador</span> 
                    <input type="radio" id="adminNo" name="permitions" class="radio" value="no" <?php echo ($result[0]['id_type'] == '2' ? "checked " : ""); echo ($_GET['id'] == $_SESSION['username'] ? "disabled" : "") ?> />
                </label>
            </div>
